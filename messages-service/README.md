...
## 🚀 Введение
Messages Service предоставляет функционал для создания и управления сообщениями в системе. 

Основные функции:

- Создание, редактирование и удаление сообщений.
- Просмотр и поиск сообщений через RESTful API.
...
```
git clone https://gitlab.meerkat-code.com/backend/messages-service.git
cd messages-service
```
...
## 🛠️ Использование
Для работы с Messages Service вы можете взаимодействовать с API-эндпоинтами для управления сообщениями.
...
```
curl -X POST http://localhost:8000/meerkat_api/messages_service/ \
-H "Content-Type: application/json" \
-H "Authorization: Token <your_token>" \
-d '{"sender": "user1", "recipient": "user2", "content": "Hello, this is a test message.", "timestamp": "2024-09-01T00:00:00Z"}'
```

Получение всех сообщений:

```
curl -X GET http://localhost:8000/meerkat_api/messages_service/ \
-H "Authorization: Token <your_token>"
```
...
```
curl -X GET http://localhost:8000/meerkat_api/messages_service/<message_id>/ \
-H "Authorization: Token <your_token>"
```
